...
public class LocationStatusType {

    /**
     * Indicates if a location is active/inactive.
     * (Required)
     * 
     */
    @JsonProperty("statusCode")
    @JsonPropertyDescription("Indicates if a location is active/inactive.")
    private String statusCode;
    /**
     * Date (inclusive of the day itself) that this location status begins.
     * 
     */
    @JsonProperty("effectiveFromDate")
    @JsonPropertyDescription("Date (inclusive of the day itself) that this location status begins.")
    private String effectiveFromDate;
    /**
     * The date up to which (exclusive of that day), location status is effective.
     * 
     */
    @JsonProperty("effectiveUpToDate")
    @JsonPropertyDescription("The date up to which (exclusive of that day), location status is effective.")
    ...
    public LocationStatusType withStatusCode(String statusCode) {
        this.statusCode = statusCode;
        return this;
    }
    ...
    public LocationStatusType withEffectiveFromDate(String effectiveFromDate) {
        this.effectiveFromDate = effectiveFromDate;
        return this;
    }
    ...
    public LocationStatusType withEffectiveUpToDate(String effectiveUpToDate) {
        this.effectiveUpToDate = effectiveUpToDate;
        return this;
    }
    ...
    public LocationStatusType withExtensions(NoCustomExtensionsType extensions) {
        this.extensions = extensions;
        return this;
    }
    ...
    public LocationStatusType withAvpList(List<EcomStringAttributeValuePairListType> avpList) {
        this.avpList = avpList;
        return this;
    }
    ...
    public LocationStatusType withActionCode(SegmentActionEnumerationType actionCode) {
        this.actionCode = actionCode;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(LocationStatusType.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof LocationStatusType) == false) {
            return false;
        }
        LocationStatusType rhs = ((LocationStatusType) other);
        return (((((((this.extensions == rhs.extensions)||((this.extensions!= null)&&this.extensions.equals(rhs.extensions)))&&((this.effectiveUpToDate == rhs.effectiveUpToDate)||((this.effectiveUpToDate!= null)&&this.effectiveUpToDate.equals(rhs.effectiveUpToDate))))&&((this.actionCode == rhs.actionCode)||((this.actionCode!= null)&&this.actionCode.equals(rhs.actionCode))))&&((this.effectiveFromDate == rhs.effectiveFromDate)||((this.effectiveFromDate!= null)&&this.effectiveFromDate.equals(rhs.effectiveFromDate))))&&((this.statusCode == rhs.statusCode)||((this.statusCode!= null)&&this.statusCode.equals(rhs.statusCode))))&&((this.avpList == rhs.avpList)||((this.avpList!= null)&&this.avpList.equals(rhs.avpList))));
    }
