...
public class TransportEquipmentType {
    ...
    public TransportEquipmentType withTransportEquipmentTypeCode(CodeType transportEquipmentTypeCode) {
        this.transportEquipmentTypeCode = transportEquipmentTypeCode;
        return this;
    }
    ...
    public TransportEquipmentType withReturnableAssetId(List<ReturnableAssetIdentificationType> returnableAssetId) {
        this.returnableAssetId = returnableAssetId;
        return this;
    }
    ...
    public TransportEquipmentType withAssetId(List<IndividualAssetIdentificationType> assetId) {
        this.assetId = assetId;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(TransportEquipmentType.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TransportEquipmentType) == false) {
            return false;
        }
        TransportEquipmentType rhs = ((TransportEquipmentType) other);
