...
public class MeasurementType {
    ...
    public MeasurementType withMeasurementUnitCode(MeasurementUnitCode measurementUnitCode) {
        this.measurementUnitCode = measurementUnitCode;
        return this;
    }
    ...
    public MeasurementType withValue(Double value) {
        this.value = value;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(MeasurementType.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof MeasurementType) == false) {
            return false;
        }
        MeasurementType rhs = ((MeasurementType) other);
