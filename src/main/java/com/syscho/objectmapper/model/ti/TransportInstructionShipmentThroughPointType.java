...
public class TransportInstructionShipmentThroughPointType {
    ...
    private ShipmentThroughPointLocationTypeEnumerationType locationType;
    /**
    ...
    public TransportInstructionShipmentThroughPointType withPrimaryId(String primaryId) {
        this.primaryId = primaryId;
        return this;
    }
    ...
    public TransportInstructionShipmentThroughPointType withAdditionalPartyId(List<AdditionalPartyIdentificationType> additionalPartyId) {
        this.additionalPartyId = additionalPartyId;
        return this;
    }
    ...
    public TransportInstructionShipmentThroughPointType withAddress(AddressType address) {
        this.address = address;
        return this;
    }
    ...
    public TransportInstructionShipmentThroughPointType withContact(List<ContactType> contact) {
        this.contact = contact;
        return this;
    }
    ...
    public TransportInstructionShipmentThroughPointType withOrganisationName(String organisationName) {
        this.organisationName = organisationName;
        return this;
    }
    ...
    public TransportInstructionShipmentThroughPointType withAddressId(String addressId) {
        this.addressId = addressId;
        return this;
    }
    ...
    public TransportInstructionShipmentThroughPointType withAddressType(String addressType) {
        this.addressType = addressType;
        return this;
    }
    ...
    public TransportInstructionShipmentThroughPointType withIsTemporaryAddress(Boolean isTemporaryAddress) {
        this.isTemporaryAddress = isTemporaryAddress;
        return this;
    }
    ...
    public TransportInstructionShipmentThroughPointType withAreGeographicalCoordinatesOverridden(Boolean areGeographicalCoordinatesOverridden) {
        this.areGeographicalCoordinatesOverridden = areGeographicalCoordinatesOverridden;
        return this;
    }
    ...
    public TransportInstructionShipmentThroughPointType withIsResidentialAddress(Boolean isResidentialAddress) {
        this.isResidentialAddress = isResidentialAddress;
        return this;
    }
    ...
    public TransportInstructionShipmentThroughPointType withNote(Description500Type note) {
        this.note = note;
        return this;
    }
    ...
    public TransportInstructionShipmentThroughPointType withAddressDistrict(String addressDistrict) {
        this.addressDistrict = addressDistrict;
        return this;
    }
    ...
    public TransportInstructionShipmentThroughPointType withAddressRegion(String addressRegion) {
        this.addressRegion = addressRegion;
        return this;
    }
    ...
    public TransportInstructionShipmentThroughPointType withHonorific(String honorific) {
        this.honorific = honorific;
        return this;
    }
    ...
    public TransportInstructionShipmentThroughPointType withExternalAddressId(String externalAddressId) {
        this.externalAddressId = externalAddressId;
        return this;
    }
    ...
    public TransportInstructionShipmentThroughPointType withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public TransportInstructionShipmentThroughPointType withTimeZoneCode(TimeZoneNameCode timeZoneCode) {
        this.timeZoneCode = timeZoneCode;
        return this;
    }
     ...
     */
    @JsonProperty("locationType")
    public ShipmentThroughPointLocationTypeEnumerationType getLocationType() {
        return locationType;
    }
     ...
     */
    @JsonProperty("locationType")
    public void setLocationType(ShipmentThroughPointLocationTypeEnumerationType locationType) {
        this.locationType = locationType;
    }

    public TransportInstructionShipmentThroughPointType withLocationType(ShipmentThroughPointLocationTypeEnumerationType locationType) {
        this.locationType = locationType;
        return this;
    }
    ...
    public TransportInstructionShipmentThroughPointType withCarrier(PartyIdentificationType carrier) {
        this.carrier = carrier;
        return this;
    }
    ...
    public TransportInstructionShipmentThroughPointType withTransportServiceLevelCode(TransportServiceLevelCode transportServiceLevelCode) {
        this.transportServiceLevelCode = transportServiceLevelCode;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(TransportInstructionShipmentThroughPointType.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("primaryId");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof TransportInstructionShipmentThroughPointType) == false) {
            return false;
        }
        TransportInstructionShipmentThroughPointType rhs = ((TransportInstructionShipmentThroughPointType) other);
        return (((((((((((((((((((((this.additionalPartyId == rhs.additionalPartyId)||((this.additionalPartyId!= null)&&this.additionalPartyId.equals(rhs.additionalPartyId)))&&((this.note == rhs.note)||((this.note!= null)&&this.note.equals(rhs.note))))&&((this.address == rhs.address)||((this.address!= null)&&this.address.equals(rhs.address))))&&((this.addressType == rhs.addressType)||((this.addressType!= null)&&this.addressType.equals(rhs.addressType))))&&((this.areGeographicalCoordinatesOverridden == rhs.areGeographicalCoordinatesOverridden)||((this.areGeographicalCoordinatesOverridden!= null)&&this.areGeographicalCoordinatesOverridden.equals(rhs.areGeographicalCoordinatesOverridden))))&&((this.locationType == rhs.locationType)||((this.locationType!= null)&&this.locationType.equals(rhs.locationType))))&&((this.primaryId == rhs.primaryId)||((this.primaryId!= null)&&this.primaryId.equals(rhs.primaryId))))&&((this.isResidentialAddress == rhs.isResidentialAddress)||((this.isResidentialAddress!= null)&&this.isResidentialAddress.equals(rhs.isResidentialAddress))))&&((this.transportServiceLevelCode == rhs.transportServiceLevelCode)||((this.transportServiceLevelCode!= null)&&this.transportServiceLevelCode.equals(rhs.transportServiceLevelCode))))&&((this.addressId == rhs.addressId)||((this.addressId!= null)&&this.addressId.equals(rhs.addressId))))&&((this.isTemporaryAddress == rhs.isTemporaryAddress)||((this.isTemporaryAddress!= null)&&this.isTemporaryAddress.equals(rhs.isTemporaryAddress))))&&((this.externalAddressId == rhs.externalAddressId)||((this.externalAddressId!= null)&&this.externalAddressId.equals(rhs.externalAddressId))))&&((this.organisationName == rhs.organisationName)||((this.organisationName!= null)&&this.organisationName.equals(rhs.organisationName))))&&((this.carrier == rhs.carrier)||((this.carrier!= null)&&this.carrier.equals(rhs.carrier))))&&((this.timeZoneCode == rhs.timeZoneCode)||((this.timeZoneCode!= null)&&this.timeZoneCode.equals(rhs.timeZoneCode))))&&((this.contact == rhs.contact)||((this.contact!= null)&&this.contact.equals(rhs.contact))))&&((this.name == rhs.name)||((this.name!= null)&&this.name.equals(rhs.name))))&&((this.addressDistrict == rhs.addressDistrict)||((this.addressDistrict!= null)&&this.addressDistrict.equals(rhs.addressDistrict))))&&((this.addressRegion == rhs.addressRegion)||((this.addressRegion!= null)&&this.addressRegion.equals(rhs.addressRegion))))&&((this.honorific == rhs.honorific)||((this.honorific!= null)&&this.honorific.equals(rhs.honorific))));
    }
